...
<center>
			...
			<center>
			<font size="5" style="font-family: Calibri, Garamond, Serif; color: red;">No record(s) to write to the output file.</font>
			</center>
			<br><br>
        <hr>
        <hr>
		<table align= "Center" style="font-family: Calibri, Garamond, Serif; ">
			<tr>
			<td colspan=125><img src="./images/Computer_training2_jpg.jpg" height=200 width=200></td>
				<td valign="Center">
					<table align= "center" >
